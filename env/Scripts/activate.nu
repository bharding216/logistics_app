...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\bharding\OneDrive - carbonfree\Documents\truck app\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\bharding\OneDrive - carbonfree\Documents\truck app\env\Scripts\deactivate.nu'
